 ...
 */
package spp2.mturrubiatesg.a10.metododeresta;
import java.util.Scanner;
/**
 *
 * @author Alumno
 */
public class SPP2MTurrubiatesGA10MetododeResta {
    ...
    public static int solicitartamaño(){
        ...
        do{
            try{
                System.out.println("Escribe el tamaño del arreglo (concidera de que es un arreglo cuadrado): ");
                a = Teclado.nextInt();
                flag = false;
            }
            catch (Exception e){
